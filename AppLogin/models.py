#
# ! REMEMBER TO DONT RUN MIGRATIONS BEFORE CREATING CUSTOM USER 
# ! CUSTOM USER DEFINING
from django.db import models
# To create a Custom User & Admin Panel
...
class MyUserManager(BaseUserManager):
    # A custom manager to deal with emails as primary unique identifier of users
    def _create_user(self, email, password, **extra_fields):
        # Creates and saves a user with a given email & password
        if not email:
...
def save_profile(sender, instance, **kwargs):
    instance.profile.save() #instance.[related_name].save()
